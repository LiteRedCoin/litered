...
Note
---------------------
Always use absolute paths to configure and compile litered and the dependencies,
...
Security
--------
To help make your litered installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, litered should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, litered may be compiled in
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://gitlab.com/litered/litered.git
    cd litered/
    ./autogen.sh
