...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"literedaddress\"\n"
            "\nReveals the private key corresponding to 'literedaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"literedaddress\"   (string, required) The litered address for the private key\n"
            "\nResult:\n"
