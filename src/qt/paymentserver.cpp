...
const QString BITCOIN_IPC_PREFIX("litered:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/litered-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/litered-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/litered-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click litered: links
...
//
// OSX-specific way of handling litered: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in litered: URIs
